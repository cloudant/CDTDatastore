...
NSString *const CDTENCRYPTION_KEYCHAIN_KEY_DPK = @"dpk";
NSString *const CDTENCRYPTION_KEYCHAIN_KEY_SALT = @"jsonSalt";
NSString *const CDTENCRYPTION_KEYCHAIN_KEY_IV = @"iv";
NSString *const CDTENCRYPTION_KEYCHAIN_KEY_ITERATIONS = @"iterations";
NSString *const CDTENCRYPTION_KEYCHAIN_KEY_VERSION = @"version";
