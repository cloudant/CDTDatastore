...
extern NSString *const CDTENCRYPTION_KEYCHAIN_KEY_DPK;
extern NSString *const CDTENCRYPTION_KEYCHAIN_KEY_SALT;
extern NSString *const CDTENCRYPTION_KEYCHAIN_KEY_IV;
extern NSString *const CDTENCRYPTION_KEYCHAIN_KEY_ITERATIONS;
extern NSString *const CDTENCRYPTION_KEYCHAIN_KEY_VERSION;
