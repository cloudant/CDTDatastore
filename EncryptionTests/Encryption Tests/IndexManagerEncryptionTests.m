...
- (void)testCreateIndexManagerWithFixedKeyProviderCiphersIndex
{
    ...
    CDTHelperFixedKeyProvider *provider = [[CDTHelperFixedKeyProvider alloc] init];
    CDTDatastore *datastore =
        [self.factory datastoreNamed:@"create_index_textests_fixedprovider_cipher"
            withEncryptionKeyProvider:provider
                                error:nil];
...
- (void)testCreateIndexManagerWithFixedKeyProviderFailsIfDBExistsAndItIsNotEncrypted
{
    // Create index
    CDTHelperFixedKeyProvider *provider = [[CDTHelperFixedKeyProvider alloc] init];
    CDTDatastore *datastore =
        [self.factory datastoreNamed:@"create_index_textests_fixedprovider_fails_with_noncipher_db"
            withEncryptionKeyProvider:provider
                                error:nil];
...
- (void)testCreateIndexManagerWithFixedKeyProviderFailsIfDBIsEncryptedButKeyIsWrong
{
    // Create index
    CDTHelperFixedKeyProvider *provider = [[CDTHelperFixedKeyProvider alloc] init];
    ...
    CDTDatastore *datastore =
        [self.factory datastoreNamed:@"create_index_textests_fixedprovider_fails_with_wrong_key"
            withEncryptionKeyProvider:provider
                                error:nil];
