...
- (void)testFactoryWithNilProviderCreatesBlobHandlesForNonEncryptedAttachments
{
    ...
    id<CDTBlobWriter> writer = [factory writer];
    id<CDTBlobMultipartWriter> multipartWriter = [factory multipartWriter];

    XCTAssertTrue([reader isKindOfClass:[CDTBlobDataReader class]], @"Unexpected type");
    XCTAssertTrue([writer isKindOfClass:[CDTBlobDataWriter class]], @"Unexpected type");
    XCTAssertTrue([multipartWriter isKindOfClass:[CDTBlobDataMultipartWriter class]],
                  @"Unexpected type");
}
...
- (void)testFactoryWithFixedProviderCreatesBlobHandlesForEncryptedAttachments
{
    ...
    XCTAssertTrue([reader isKindOfClass:[CDTBlobEncryptedDataReader class]], @"Unexpected type");
    XCTAssertTrue([writer isKindOfClass:[CDTBlobEncryptedDataWriter class]], @"Unexpected type");
    XCTAssertTrue([multipartWriter isKindOfClass:[CDTBlobEncryptedDataMultipartWriter class]],
                  @"Unexpected type");
}
